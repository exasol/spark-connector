...
/**
 * Abstract setup for data writing integration tests.
 */
abstract class AbstractDataWritingIntegrationTest extends S3IntegrationTestSetup {

    private final String format;

    public AbstractDataWritingIntegrationTest(final String format) {
        this.format = format;
    }
